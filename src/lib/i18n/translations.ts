...
export const translations = {
  zh: {
    nav: {
      customer: { home: "首页", healthyPicks: "好物", rewards: "Glowing You", progress: "成长", profile: "我的" },
  ...
  en: {
    nav: {
      customer: { home: "Home", healthyPicks: "Healthy Picks", rewards: "Glowing You", progress: "Growth", profile: "Profile" },
