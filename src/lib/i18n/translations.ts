...
export const translations = {
  zh: {
    nav: {
      ...
      coach: { dashboard: "概览", customers: "顾客", alerts: "提醒", messages: "消息", referral: "推荐", profile: "我的" },
  ...
  en: {
    nav: {
      ...
      coach: { dashboard: "Dashboard", customers: "Customers", alerts: "Alerts", messages: "Messages", referral: "Referral", profile: "Profile" },
