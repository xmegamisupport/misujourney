...
export const translations = {
  zh: {
    nav: {
      customer: { home: "首页", healthyPicks: "好物", rewards: "健康收藏", progress: "成长", profile: "我的" },
  ...
  en: {
    nav: {
      customer: { home: "Home", healthyPicks: "Healthy Picks", rewards: "Collection", progress: "Growth", profile: "Profile" },
