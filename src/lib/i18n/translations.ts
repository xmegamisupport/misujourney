...
export const translations = {
  zh: {
    nav: {
      customer: { home: "首页", healthyPicks: "好物", rewards: "Glowing You", leaderboard: "排行榜", profile: "我的" },
  ...
  en: {
    nav: {
      customer: { home: "Home", healthyPicks: "Healthy Picks", rewards: "Glowing You", leaderboard: "Leaderboard", profile: "Profile" },
