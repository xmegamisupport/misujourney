...
export default function PointsGuidePage() {
  ...
  return (
    <div className="flex flex-col gap-6 px-4 pb-8 md:px-8">
      ...
      <p className="rounded-lg border border-brand-soft/40 bg-brand-tint px-4 py-3.5 text-sm leading-relaxed text-ink-soft">
      ...
      {/* Daily */}
      <section>
        <p className="mb-2 text-sm font-semibold text-ink">每天可以累积</p>
        <div className="overflow-hidden rounded-lg border border-line bg-surface shadow-elev1">
      ...
      <section>
        <p className="mb-2 text-sm font-semibold text-ink">晨重的时间奖励</p>
        <div className="overflow-hidden rounded-lg border border-line bg-surface shadow-elev1">
      ...
      {/* Consistency */}
      <section>
        <p className="mb-2 text-sm font-semibold text-ink">坚持的奖励</p>
        <div className="overflow-hidden rounded-lg border border-line bg-surface shadow-elev1">
      ...
      {/* Milestones */}
      <section>
        <p className="mb-2 text-sm font-semibold text-ink">重要的里程碑</p>
        <div className="overflow-hidden rounded-lg border border-line bg-surface shadow-elev1">
...
function Row({
  ...
  return (
    <div className="flex items-center gap-3 border-b border-line-soft px-4 py-3 last:border-b-0">
      <span className="text-lg">{icon}</span>
      <div className="min-w-0 flex-1">
        <p className="text-sm text-ink">{label}</p>
        {hint && <p className="mt-0.5 text-xs text-ink-faint">{hint}</p>}
      </div>
      <span className={`shrink-0 text-sm font-semibold ${highlight ? "text-brand" : "text-ink-soft"}`}>{value}</span>
    </div>
  );
}
